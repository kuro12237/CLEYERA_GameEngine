...
/// 敵の基底クラス
/// </summary>
class BaseEnemy : public CLEYERA::Component::ObjectComponent {
public:
    /// <summary>
    /// コンストラクタ
    /// </summary>
    BaseEnemy() { hp_ = std::make_unique<HealthComponent>(); };
...
public:
    ...
    /// </summary>
    /// <returns></returns>
    inline EnemyParameter GetEnemyParameter() const { return parameter_; }
