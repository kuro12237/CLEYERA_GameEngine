...
/// 雑魚敵の弾
/// </summary>
class DonutNormalEnemyBullet : public BaseNormalEnemyBullet {
public:
  /// <summary>
  /// コンストラクタ
  /// </summary>
    DonutNormalEnemyBullet() = default;
...
private:
  ...
  //最大のサイズ
  const float_t MAX_SCALE_ = 2.0f;
  //最小のサイズ
  const float_t MIN_SCALE_ = 0.5f;


private:
    float_t bulletScele_ = 0.0f;
