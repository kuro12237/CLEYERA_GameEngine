...
/// 指定したLuaスクリプトの読み込み
/// </summary>
void CLEYERA::Manager::LuaManager::LoadScript(const std::string &rootPath, const std::string &fileName) 
{
...
/// スクリプトのリロード
/// </summary>
void CLEYERA::Manager::LuaManager::ReLoadScript(const std::string &scriptName) 
{
...
/// 指定したスクリプトを取得
/// </summary>
std::weak_ptr<LuaScript> CLEYERA::Manager::LuaManager::GetScript(const std::string &scriptName) 
{ 
	try {
...
/// 指定したスクリプトを解放
/// </summary>
void CLEYERA::Manager::LuaManager::UnLoadScript(const std::string &scriptName) 
{
...
/// スクリプトの変更を監視
/// </summary>
void CLEYERA::Manager::LuaManager::MonitorScript() 
{
...
/// </summary>
std::string CLEYERA::Manager::LuaManager::RemoveNameSuffix(const std::string &filePath) 
{ 
