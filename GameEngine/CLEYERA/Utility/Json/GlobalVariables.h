...
#pragma endregion
   ...
   struct Item {
      // 項目の値
      std::variant<int32_t, float, bool, Math::Vector::Vec2, Math::Vector::Vec3, Math::Vector::Vec4> value;
   };
   // グループ
   struct Group {
...
template <typename T> inline T GlobalVariables::GetValue(const std::string &groupName, const std::string &key) {
