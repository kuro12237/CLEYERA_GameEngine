...
void WinApp::Create() {
  ...
  hwnd_ = CreateWindow(wc_.lpszClassName, L"CLEYERA", WS_OVERLAPPEDWINDOW,
  ...
  HFONT hFont =
      CreateFont(24, 0, 0, 0, FW_NORMAL, FALSE, FALSE, FALSE, DEFAULT_CHARSET,
                 ...
                 CLEARTYPE_NATURAL_QUALITY, DEFAULT_PITCH | FF_SWISS, L"Arial");
...
void CLEYERA::Base::Win::WinApp::Finalize() {
    CloseWindow(hwnd_);
}
...
LRESULT CLEYERA::Base::Win::WinApp::WindowProc(HWND hwnd, UINT msg,
